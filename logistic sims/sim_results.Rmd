...
summary.table <- ddply(new.table, ~method, summarise, 
                       ...
                       cor.all.hoslem = mean(cor.all.hoslem),
                       cor.native.hoslem = mean(cor.native.hoslem),
...
```{r warning = FALSE, echo = FALSE}
qplot(test.auc, cor.native.hoslem, data=new.table, color = method, facets = method ~ 1)
print(summary(lm(cor.native.hoslem ~ test.auc,  data = new.table)))
kable(lm.methods(new.table, formula(cor.native.hoslem ~ test.auc)))
```
<br>
<br>
<br>
...
```{r warning = FALSE, echo = FALSE}
qplot(test.auc, cor.all.hoslem, data=new.table, color = method, facets = method ~ 1)
print(summary(lm(cor.all.hoslem ~ test.auc,  data = new.table)))
kable(lm.methods(new.table, formula(cor.all.hoslem ~ test.auc)))
```
<br>
<br>
<br>
...
```{r warning = FALSE, echo = FALSE}
qplot(test.max.tss, cor.native.hoslem, data=new.table, color = method, facets = method ~ 1)
print(summary(lm(cor.native.hoslem ~ test.max.tss, data = new.table)))
kable(lm.methods(new.table, formula(cor.native.hoslem ~ test.max.tss)))

qplot(test.max.tss, cor.all.hoslem, data=new.table, color = method, facets = method ~ 1)
print(summary(lm(cor.all.hoslem ~ test.max.tss, data = new.table)))
kable(lm.methods(new.table, formula(cor.all.hoslem ~ test.max.tss)))
```
<br>
<br>
<br>
...
```{r warning = FALSE, echo = FALSE}
qplot(test.max.kappa, cor.native.hoslem, data=new.table, color = method, facets = method ~ 1)
print(summary(lm(cor.native.hoslem ~ test.max.kappa, data = new.table)))
kable(lm.methods(new.table, formula(cor.native.hoslem ~ test.max.kappa)))
qplot(test.max.kappa, cor.all.hoslem, data=new.table, color = method, facets = method ~ 1)
print(summary(lm(cor.all.hoslem ~ test.max.kappa,data = new.table)))
kable(lm.methods(new.table, formula(cor.all.hoslem ~ test.max.kappa)))
```
<br>
<br>
<br>
...
```{r warning = FALSE, echo = FALSE}
qplot(bias.strength, cor.native.hoslem, data=new.table, color = method, facets = method ~ 1)
print(summary(lm(cor.native.hoslem ~ bias.strength,  data = new.table)))
kable(lm.methods(new.table, formula(cor.native.hoslem ~ bias.strength)))
```
<br>
<br>
<br>
...
```{r warning = FALSE, echo = FALSE}
qplot(occupancy, cor.native.hoslem, data = new.table, color = method, facets = method ~ 1)
print(summary(lm(cor.native.hoslem ~ occupancy,  data = new.table[new.table$method != "rf",])))
kable(lm.methods(new.table, formula(cor.native.hoslem ~ occupancy)))
```
<br>
<br>
<br>
...
```{r warning = FALSE, echo = FALSE}
s3d <- scatterplot3d(new.table$occupancy, new.table$bias.strength, new.table$cor.native.hoslem)
my.lm <- lm(new.table$cor.native.hoslem ~ new.table$bias.strength + new.table$occupancy)
s3d$plane3d(my.lm)
### Note to self: significant effects fall out once interaction between bias and occupancy is included
native.lm <- lm(cor.native.hoslem ~ bias.strength * occupancy,  data = new.table)
print(summary(native.lm))
```
<br>
<br>
...
```{r warning = FALSE, echo = FALSE}
qplot(bias.strength, cor.all.hoslem, data=new.table, color = method, facets = method ~ 1)
print(summary(lm(cor.all.hoslem ~ bias.strength,  data = new.table)))
kable(lm.methods(new.table, formula(cor.all.hoslem ~ bias.strength)))
```
<br>
<br>
<br>
...
```{r warning = FALSE, echo = FALSE}
qplot(occupancy, cor.all.hoslem, data = new.table, color = method, facets = method ~ 1)
print(summary(lm(cor.all.hoslem ~ occupancy,  data = new.table)))
kable(lm.methods(new.table, formula(cor.all.hoslem ~ occupancy)))
```
<br>
<br>
<br>
...
```{r warning = FALSE, echo = FALSE}
s3d <- scatterplot3d(new.table$occupancy, new.table$bias.strength, new.table$cor.all.hoslem)
my.lm <- lm(new.table$cor.all.hoslem ~ new.table$bias.strength + new.table$occupancy)
s3d$plane3d(my.lm)
### Note to self: significant effects fall out once interaction between bias and occupancy is included
all.lm <- lm(cor.all.hoslem ~ bias.strength * occupancy,  data = new.table)
print(summary(all.lm))
```
<br>
<br>
...
```{r warning = FALSE, echo = FALSE}
qplot(true.breadth, cor.native.hoslem, data = new.table, color = method, facets = method ~ 1)
print(summary(lm(cor.native.hoslem ~ true.breadth,  data = new.table)))
kable(lm.methods(new.table, formula(cor.native.hoslem ~ true.breadth)))
```
<br>
<br>
<br>
...
```{r warning = FALSE, echo = FALSE}
qplot(true.breadth, cor.all.hoslem, data = new.table, color = method, facets = method ~ 1)
print(summary(lm(cor.all.hoslem ~ true.breadth,  data = new.table)))
kable(lm.methods(new.table, formula(cor.all.hoslem ~ true.breadth)))
