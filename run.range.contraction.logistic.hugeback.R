...
source("./R/SDM-sim.R")
source("range.contraction.sim.logistic.hugeback.R")
...
range.contraction.sim.logistic(bias.raster = bias.raster, outfile = "./logistic sims hugeback/newtest", replace = TRUE, bias.strength = 0.2, allopatry = TRUE)
