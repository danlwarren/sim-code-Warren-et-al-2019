...
nsuit <- 0
while(nsuit < 50){
  these.vars <- sample(names(env), nvars + 2)
  this.species <- generateRandomSp(stack(env[[these.vars[1:nvars]]]), plot=FALSE, beta = 0.5)
...
env <- env[[these.vars]]
print(paste("Using variables ", names(env)))
print(this.species)
...
cor.native.hoslem <- raster.cor(predglm * range.raster, prob.raster * range.raster, method = "hoslem", g = 10)
...
print(paste("Hosmer-Lemeshow GOF statistic with true suitability (native range):", cor.native.hoslem))
print("Train AUC:")
print(trainauc)
plot(trainauc, 'ROC')
print("Test AUC:")
...
if(is.na(testauc@auc) | is.na(trainauc@auc) ){
  ...
  out.table <- rbind(out.table, c("glm", bias.strength, occupancy, "cor.all.hoslem", NA))
  out.table <- rbind(out.table, c("glm", bias.strength, occupancy, "cor.native.hoslem", NA))
  ...
  out.table <- rbind(out.table, c("glm", bias.strength, occupancy, "cor.all.hoslem", raster.cor(predglm, prob.raster, method = "hoslem", g = 10)))
  out.table <- rbind(out.table, c("glm", bias.strength, occupancy, "cor.native.hoslem", cor.native.hoslem))
...
gam.formula <- paste0("s(", names(env), ")")
gam.formula <- paste(gam.formula, collapse = " + ")
gam.formula <- formula(x = paste0("species ~ ", gam.formula))
print(gam.formula)

this.gam <- gam(terms(gam.formula, data = pointdata[group != 1,-c(2,3)]), 
...
cor.native.hoslem <- raster.cor(predgam * range.raster, prob.raster * range.raster, method = "hoslem", g = 10)
...
if(is.na(testauc@auc) | is.na(trainauc@auc) ){
  ...
  out.table <- rbind(out.table, c("gam", bias.strength, occupancy, "cor.all.hoslem", NA))
  out.table <- rbind(out.table, c("gam", bias.strength, occupancy, "cor.native.hoslem", NA))
  ...
  out.table <- rbind(out.table, c("gam", bias.strength, occupancy, "cor.all.hoslem", raster.cor(predgam, prob.raster, method = "hoslem", g = 10)))
  out.table <- rbind(out.table, c("gam", bias.strength, occupancy, "cor.native.hoslem", cor.native.hoslem))
...
cor.native.hoslem <- raster.cor(predbc * range.raster, prob.raster * range.raster, method = "hoslem", g = 10)
...
if(is.na(testauc@auc) | is.na(trainauc@auc) ){
  ...
  out.table <- rbind(out.table, c("bc", bias.strength, occupancy, "cor.all.hoslem", NA))
  out.table <- rbind(out.table, c("bc", bias.strength, occupancy, "cor.native.hoslem", NA))
  ...
  out.table <- rbind(out.table, c("bc", bias.strength, occupancy, "cor.all.hoslem", raster.cor(predbc, prob.raster, method = "hoslem", g = 10)))
  out.table <- rbind(out.table, c("bc", bias.strength, occupancy, "cor.native.hoslem", cor.native.hoslem))
...
cor.native.hoslem <- raster.cor(preddm * range.raster, prob.raster * range.raster, method = "hoslem", g = 10)
...
if(is.na(testauc@auc) | is.na(trainauc@auc) ){
  ...
  out.table <- rbind(out.table, c("dm", bias.strength, occupancy, "cor.all.hoslem", NA))
  out.table <- rbind(out.table, c("dm", bias.strength, occupancy, "cor.native.hoslem", NA))
  ...
  out.table <- rbind(out.table, c("dm", bias.strength, occupancy, "cor.all.hoslem", raster.cor(preddm, prob.raster, method = "hoslem", g = 10)))
  out.table <- rbind(out.table, c("dm", bias.strength, occupancy, "cor.native.hoslem", cor.native.hoslem))
...
cor.native.hoslem <- raster.cor(predmx * range.raster, prob.raster * range.raster, method = "hoslem", g = 10)
...
if(is.na(testauc@auc) | is.na(trainauc@auc) ){
  ...
  out.table <- rbind(out.table, c("mx", bias.strength, occupancy, "cor.all.hoslem", NA))
  out.table <- rbind(out.table, c("mx", bias.strength, occupancy, "cor.native.hoslem", NA))
  ...
  out.table <- rbind(out.table, c("mx", bias.strength, occupancy, "cor.all.hoslem", raster.cor(predmx, prob.raster, method = "hoslem", g = 10)))
  out.table <- rbind(out.table, c("mx", bias.strength, occupancy, "cor.native.hoslem", cor.native.hoslem))
...
cor.native.hoslem <- raster.cor(predrf * range.raster, prob.raster * range.raster, method = "hoslem", g = 10)
...
if(is.na(testauc@auc) | is.na(trainauc@auc) ){
  ...
  out.table <- rbind(out.table, c("rf", bias.strength, occupancy, "cor.all.hoslem", NA))
  out.table <- rbind(out.table, c("rf", bias.strength, occupancy, "cor.native.hoslem", NA))
  ...
  out.table <- rbind(out.table, c("rf", bias.strength, occupancy, "cor.all.hoslem", raster.cor(predrf, prob.raster, method = "hoslem", g = 10)))
  out.table <- rbind(out.table, c("rf", bias.strength, occupancy, "cor.native.hoslem", cor.native.hoslem))
...
this.brt <- gbm.step(data = pointdata[group != 1,], gbm.x = 4:ncol(pointdata), gbm.y = 1, family = "bernoulli")
...
cor.native.hoslem <- raster.cor(predbrt * range.raster, prob.raster * range.raster, method = "hoslem", g = 10)
...
if(is.na(testauc@auc) | is.na(trainauc@auc) ){
  ...
  out.table <- rbind(out.table, c("brt", bias.strength, occupancy, "cor.all.hoslem", NA))
  out.table <- rbind(out.table, c("brt", bias.strength, occupancy, "cor.native.hoslem", NA))
  ...
  out.table <- rbind(out.table, c("brt", bias.strength, occupancy, "cor.all.hoslem", raster.cor(predbrt, prob.raster, method = "hoslem", g = 10)))
  out.table <- rbind(out.table, c("brt", bias.strength, occupancy, "cor.native.hoslem", cor.native.hoslem))
